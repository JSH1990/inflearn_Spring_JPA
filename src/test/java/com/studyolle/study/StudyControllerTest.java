...
public class StudyControllerTest {
    ...
    void createStudy_success() throws Exception {
        mockMvc.perform(post("/new-study")
                ...
                .param("shortDescription", "study shortDescription")
                .param("fullDescription", "study FullDescription")
                .with(csrf()))
    ...
    void viewStudy() throws Exception {
        ...
        study.setShortDescription("study shortDescription");
        study.setFullDescription("study FullDescription");
